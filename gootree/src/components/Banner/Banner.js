    ...
    <section>
      <Slider {...settings} className="relative">
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-start p-4 md:p-10 bg-black bg-opacity-30">
            <div className="text-white">
              ...
              <button className="border rounded-md border-gray-500 px-3 py-1 md:px-4 md:py-2 mt-4 md:mt-5 font-sans text-sm md:text-md text-white bg-green-900 hover:bg-green-700">
                SHOP NOW
              </button>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-start p-4 md:p-10 bg-black bg-opacity-50">
            <div className="text-white">
              <h2 className="text-2xl md:text-6xl font-serif text-lime-200">New Collection</h2>
              <span className="text-xl md:text-6xl font-sans text-lime-300">Discount on All Items</span>
              <p className="text-sm md:text-md mt-4">
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-start p-4 md:p-10 bg-black bg-opacity-50">
            <div className="text-white">
              <h2 className="text-2xl md:text-6xl font-serif text-lime-200">New Collection</h2>
              <span className="text-xl md:text-6xl font-sans text-lime-200">Discount on All Items</span>
              <p className="text-sm md:text-md mt-4">
                Discover our new collection of planters and get a free grow light on every purchase!
              </p>
              <button className="border rounded-md border-gray-500 px-3 py-1 md:px-4 md:py-2 mt-4 md:mt-5 font-sans text-sm md:text-md text-white bg-green-900 hover:bg-green-700">
