...
function HeroSection3() {
  return (
    <div className="relative bg-orange-200 p-5 md:p-10 flex flex-col md:flex-row justify-center items-center">
      ...
      <div className="relative w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0">
        ...
        <div className="absolute flex justify-center items-center w-[70%] h-[70%] md:w-full md:h-full">
