...
import image from '../../assets/logo/36.webp';
...
function HeroSection3() {
  ...
  return (
    <div ref={containerRef } className="relative  p-5 md:p-10 flex flex-col md:flex-row justify-center items-center">
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0">
        ...
        <div className="slide-in flex justify-center items-center w-[70%] h-[70%] md:w-[600px] md:h-[500px]">
